    ...
    \begin{enumerate}[(a)]
      ...
      \item Wollen ein Verlies plündern, welches ein Schatzniveau von mehr als 80 besitzt.
            $$\begin{aligned}
                 ...
                 & \quad(\mathrm{Held})                                                               \\
                 & \quad\quad\bowtie_{\mathrm{SchatzNiveau}>80,\mathrm{WillPluendern}=\mathrm{VerID}} \\
                 & \quad(\mathrm{Verlies})                                                            \\
                 & )                                                                                  \\
              \end{aligned}$$
    \end{enumerate}
...
\begin{aufgabe}
  \begin{teilaufgabe}
    ...
    Sei $t$ ein Tupel, dass $r$-mal in $R$ vorkommt, $s$-mal in $S$ vorkommt und $t$-mal in $T$ vorkommt.
